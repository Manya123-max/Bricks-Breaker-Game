...
font = pygame.font.SysFont('Arabic', 60)
...
'''
    ...
    def draw(self):
        pygame.draw.circle(window, (255, 0, 0), (self.rect.x +
...
while game:
    ...
    if not my_ball:
        if game_over == 0:
            draw_text('TOUCH TO RESTART', font,
                      w_brick, 200, Window_height // 2 + 100)
        elif game_over == 1:
            draw_text('YOU WON!', font, w_brick, 300, Window_height // 2 + 50)
            draw_text('TOUCH TO RESTART', font,
                      w_brick, 200, Window_height // 2 + 100)
        elif game_over == -1:
            draw_text('GAME OVER!', font, w_brick,
                      280, Window_height // 2 + 50)
            draw_text('TOUCH TO RESTART', font,
                      w_brick, 200, Window_height // 2 + 100)
